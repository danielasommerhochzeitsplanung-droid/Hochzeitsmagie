...
import { CheckCircle2, Circle, Calendar, AlertCircle, Plus, Filter, X, RefreshCw, Pencil as Edit2, ChevronDown, ChevronRight, Lock, Archive, Search, ListPlus } from 'lucide-react';
...
export default function TodosModule() {
  ...
  const recalculateAutoTaskDates = () => {
    ...
    const autoTasks = tasks.filter(task => task.is_system_generated && !task.completed && task.template_id);
